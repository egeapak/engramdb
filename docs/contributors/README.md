...
7. [parallelization-simd.md](./parallelization-simd.md) — which bulk paths are rayon-parallel or vectorized, what each measured, and why the release profile currently suppresses the SIMD half.
