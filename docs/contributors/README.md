...
7. [parallelization-simd.md](./parallelization-simd.md) — which bulk paths are rayon-parallel, what each measured, why the fast dot product is instruction-level parallelism rather than SIMD, and why the release profile suppresses it.
